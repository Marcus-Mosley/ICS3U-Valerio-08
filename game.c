...
// This program includes attacking and blocking
...
ValerioCharacter valerio;
ValerioCharacter enemy_1;
ValerioCharacter enemy_2;
ValerioCharacter enemy_3;
ValerioCharacter enemy_4;
ValerioCharacter enemy_5;
UBYTE spritesize = 8;
const char blankmap[1] = {0x00};
UBYTE gamerunning, stage, attack, block;
unsigned int seed = 0;
